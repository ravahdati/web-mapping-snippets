...
namespace WebMappingSnippets
{
    /// <summary>
    /// Map Display Helper for .NET Core C#
    ...
    public class MapHelper
    {
        ...
        /// </summary>
        /// <returns>Dictionary of supported map providers</returns>
        public static Dictionary<string, string> ShowAvailableMaps()
        {
        ...
        /// <param name="provider">Map provider - Options: google, cedarmaps, neshan, mapir, parsimap, mapbox, osm, bing, yandex</param>
        /// <returns>HTML string to render the map</returns>
        public static string DisplayMapWithLocation(double latitude, double longitude, string provider = "google")
        {
            var html = "<div id='map' style='width: 100%; height: 400px;'></div>";
